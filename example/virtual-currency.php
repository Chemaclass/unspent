...
$game = $game->apply(Tx::create(
    spendIds: ['alice-after-sword', 'quest-reward'],
    outputs: [
...
$game = $game->apply(Tx::create(
    spendIds: ['shop-inventory', 'payment-for-sword', 'payment-for-armor'],
    outputs: [
...
try {
    $game->apply(Tx::create(
        spendIds: ['alice-starting-gold'], // Already spent!
